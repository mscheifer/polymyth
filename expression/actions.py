...
ask_after = Action("person", "conversation_partner_relative")
ask_if_want = Action("asker", "askee", "thing")
ask_if_father_left_town = Action("pi", "client")
ask_if_i_talk_a_lot = Action("asker", "askee")
...
avoid_interaction_with_mother = Action("person", "mother")
be_cocky_on_phone = Action("person", "date")
...
meet_pi = Action("pi", "client")
open_paper = Action("person")
pretend_wasnt_trying_to_fool = Action("con", "fool")
...
say_altering_the_deal = Action("person")
...
say_no_you_dont = Action("speaker")
...
say_yeah_you_do = Action("speaker")
...
say_you_talk_a_lot = Action("person")
scene_transition = Action()
...
talk_about_fight_waiter = Action("person", "date")
